"""Build the file-manager Agent using the `internal_tool` preset.

Safety: only READ operations auto-execute. MOVE, COPY, CREATE, WRITE
all require confirmation. DELETE always requires confirmation.
"""
...
def build_agent(audit_path: str = "./filemanager_audit.jsonl") -> Agent:
